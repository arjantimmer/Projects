...
<div class="container">
  ...
  <div class="row-fluid">
    <div class="<?php if(!is_active_sidebar('sidebar-primary')){ echo 'span12'; }else { echo 'span8'; } ?>" id="main-content">
      <?php if ( have_posts() ) : ?>
      <h2><?php printf( __( "Zoekresultaten:", 'sis_spa' ), '<span>' . get_search_query() . '</span>' ); ?></h2>
      <?php /* Start the Loop */ ?>
      ...
      <h2 class="blog-heading"><?php _e( "Helaas niets gevonden", 'sis_spa' ); ?></h2>
      <div class="">
        <p><?php _e( "We hebben geen resultaten gevonden. Probeer opnieuw.", 'sis_spa' ); ?></p>
      </div>
      <!-- .blog_con_mn -->
      <?php endif; ?>
    </div>
