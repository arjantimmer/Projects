...
<div class="container">
  ...
  <div class="row-fluid">
    ...
    <div class="<?php if(!is_active_sidebar('sidebar-primary')){ echo 'span12'; }else { echo 'span8'; } ?> " id="post_single">
      <!--  	  Blog-post-detail 1--> 
      <?php the_post();?>
      ...
      <div class="media" >
        <a class="blog_detail_head" href="<?php the_permalink(); ?>"title="<?php the_title(); ?>"><?php the_post_thumbnail('', $defalt_arg); ?></a>
      </div>
      <?php endif;?>
      <div class="media" >
